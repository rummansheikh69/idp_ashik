...
export function Counseling() {
  ...
  return (
    ...
    >
      {/* Top decorative wave */}
      <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-b from-primary via-accent to-primary" />

      {/* Background radial glow */}
      <div className="absolute bottom-40 -left-40 w-[400px] h-1/2 bg-accent/30 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-10">
              Talk to one of our certified education consultants at no cost.
              We'll review your profile and guide you toward the best study or
              visa pathway.
            </p>
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              {[
                ...
                <span
                  key={b}
                  className="inline-flex items-center gap-1.5 bg-secondary px-3 py-1.5 rounded-full text-xs font-semibold text-foreground/70 border border-border"
                >
          ...
          <motion.div
            ...
            className="lg:col-span-3 w-full h-full  flex items-center justify-center"
          >
              ...
              {submitted ? (
                <div className="flex flex-col items-center justify-center py-16 text-center">
                  ...
                  <p className="text-muted-foreground max-w-sm">
                    One of our counsellors will be in touch with you within 24
                ...
                <>
                  <h3 className="text-xl font-display font-bold text-foreground mb-7">
